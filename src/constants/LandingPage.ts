...
export const perks = [
  ...
  },
  {
    icon: Icons.launch,
    title: "Launch",
    info: "Publish your tournament and share it with the world.",
  },
];
...
export const features = [
  {
    icon: Icons.bolt,
    title: "Fast Setup",
    info: "Get your e-sports tournament up and running in minutes with our intuitive AI-powered builder.",
  },
  {
    icon: Icons.palette,
    title: "Customizable Templates",
    info: "Choose from a variety of stunning templates and customize them to suit your tournament.",
  },
  {
    icon: Icons.seo,
    title: "SEO Optimized",
    info: "Built-in SEO features ensure your e-sports tournament ranks well on search engines.",
  },
  {
    icon: Icons.monitor,
    title: "Responsive Design",
    info: "Your tournament will look great on any device, from desktops to mobile phones.",
  },
  {
    icon: Icons.shop,
  ...
  },
  {
    ...
    info: "Enjoy peace of mind with secure and reliable hosting for your tournament.",
  },
];
